...
import '../Controllers/PoliceHistoryController.dart';
import 'PoliceDashBoard.dart';

class PoliceHistorySreen extends StatefulWidget {
  const PoliceHistorySreen({Key? key}) : super(key: key);

  @override
  State<PoliceHistorySreen> createState() => _PoliceHistorySreenState();
}

class _PoliceHistorySreenState extends State<PoliceHistorySreen> {
  final _controller = Get.put(PoliceHistoryController());
  @override
